...
INSERT INTO `##flink` (`DATE_CREATED`, `DATE_UPDATED`, `FORMIN`, `FORMOUT`, `ACTION`, `ICON`, `DISPLAYIN`, `MAPPING`, `FORMOUTALT`, `REDIRECT`, `ACTIONIN`, `ACTIONOUT`, `DISPLAYOUT`) VALUES('0000-00-00 00:00:00', NULL, (select `id` from `##faces` where `name`='flink'), (select `id` from `##faces` where `name`='flink'), 'edit', 'edit.png', 'list', NULL, NULL, NULL, NULL, 'edit', 'form');
INSERT INTO `##flink` (`DATE_CREATED`, `DATE_UPDATED`, `FORMIN`, `FORMOUT`, `ACTION`, `ICON`, `DISPLAYIN`, `MAPPING`, `FORMOUTALT`, `REDIRECT`, `ACTIONIN`, `ACTIONOUT`, `DISPLAYOUT`) VALUES('0000-00-00 00:00:00', NULL, (select `id` from `##faces` where `name`='faccess'), (select `id` from `##faces` where `name`='faccess'), 'edit', 'edit.png', 'list', NULL, NULL, NULL, NULL, 'edit', 'form');
INSERT INTO `##flink` (`DATE_CREATED`, `DATE_UPDATED`, `FORMIN`, `FORMOUT`, `ACTION`, `ICON`, `DISPLAYIN`, `MAPPING`, `FORMOUTALT`, `REDIRECT`, `ACTIONIN`, `ACTIONOUT`, `DISPLAYOUT`) VALUES('0000-00-00 00:00:00', NULL, (select `id` from `##faces` where `name`='frole'), (select `id` from `##faces` where `name`='frole'), 'edit', 'edit.png', 'list', NULL, NULL, NULL, NULL, 'edit', 'form');
INSERT INTO `##flink` (`DATE_CREATED`, `DATE_UPDATED`, `FORMIN`, `FORMOUT`, `ACTION`, `ICON`, `DISPLAYIN`, `MAPPING`, `FORMOUTALT`, `REDIRECT`, `ACTIONIN`, `ACTIONOUT`, `DISPLAYOUT`) VALUES('0000-00-00 00:00:00', NULL, (select `id` from `##faces` where `name`='flink'), (select `id` from `##faces` where `name`='flink'), 'delete', 'delete.png', 'list', NULL, NULL, NULL, NULL, 'delete', 'form');
INSERT INTO `##flink` (`DATE_CREATED`, `DATE_UPDATED`, `FORMIN`, `FORMOUT`, `ACTION`, `ICON`, `DISPLAYIN`, `MAPPING`, `FORMOUTALT`, `REDIRECT`, `ACTIONIN`, `ACTIONOUT`, `DISPLAYOUT`) VALUES('0000-00-00 00:00:00', NULL, (select `id` from `##faces` where `name`='faccess'), (select `id` from `##faces` where `name`='faccess'), 'delete', 'delete.png', 'list', NULL, NULL, NULL, NULL, 'delete', 'form');
INSERT INTO `##flink` (`DATE_CREATED`, `DATE_UPDATED`, `FORMIN`, `FORMOUT`, `ACTION`, `ICON`, `DISPLAYIN`, `MAPPING`, `FORMOUTALT`, `REDIRECT`, `ACTIONIN`, `ACTIONOUT`, `DISPLAYOUT`) VALUES('0000-00-00 00:00:00', NULL, (select `id` from `##faces` where `name`='frole'), (select `id` from `##faces` where `name`='frole'), 'delete', 'delete.png', 'list', NULL, NULL, NULL, NULL, 'delete', 'form');
