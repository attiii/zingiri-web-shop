...
$menus['showcustomers']=array('page' => 'customeradmin', 'group' => 'admin23', 'label' => 'admin3','href' => 'page=customeradmin&action=showcustomers', 'img' => 'customers.gif', 'func' => 'CountCustomers','param' => 'CUSTOMER');
...
$menus['advancedsettings']=array('type' => 'apps', 'group' => 'admin23', 'label' => 'editsettings93','href' => 'zfaces=form&form=settings', 'img' => 'settings.gif');
...
$menus['adminedit2']=array('page' => 'adminedit', 'group' => 'admin24', 'label' => 'admin19','href' => 'page=adminedit&filename=banned.txt&root=1&wysiwyg=0', 'img' => 'banned.gif');
$menus['adminedit3']=array('page' => 'adminedit', 'group' => 'admin24', 'label' => 'admin22','href' => 'page=adminedit&filename=main.txt&root=0', 'img' => 'mainadmin.gif');
$menus['adminedit4']=array('page' => 'adminedit', 'group' => 'admin24', 'label' => 'admin37','href' => 'page=adminedit&filename=countries.txt&root=1&wysiwyg=0', 'img' => 'countries.gif');
$menus['prompts']=array('type' => 'apps', 'group' => 'admin23', 'label' => 'admin101','href' => 'zfaces=list&form=prompt', 'img' => 'countries.gif');
...
$menus['customer']=array('group' => 'my5', 'label' => 'my7','href' => 'page=customer&action=show', 'img' => 'customers.gif');
$menus['orders']=array('group' => 'my5', 'label' => 'my8','href' => 'page=orders&id='.$customerid, 'img' => 'orders.gif');
$menus['cart']=array('group' => 'my5', 'label' => 'my9','href' => 'page=cart&action=show', 'img' => 'carticon.gif');
$menus['products']=array('group' => 'my5', 'label' => 'admin5','href' => 'page=products&action=show', 'img' => 'products.gif');
?>