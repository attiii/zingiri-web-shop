...
INSERT INTO `##faccess` (`FORMID`,`ACTION`,`RULES`,`ROLEID`,`DATE_CREATED`) VALUES (58,'add','',3,'2010-06-15 09:36:52');
...
INSERT INTO `##faccess` (`FORMID`,`ACTION`,`RULES`,`ROLEID`,`ALLOWED`,`DATE_CREATED`) VALUES (0,0,'',1,1,'2010-06-15 09:38:42');
...
- Delete obsolete access controls
DELETE FROM `##faccess` WHERE `ID`=1;
