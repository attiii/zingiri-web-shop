...
INSERT INTO `settings` VALUES(1, 'Netherlands', 10, 1, 'Kg', 'euro', 'E', 12, 1.19, '19%', 1, 'sales@your+domain.com', 'FreeWebshop.org', 'http://www.your+domain.com/shop', 'nl', 'WEB', '-08', 1, 1, 0, 'Closed', 'Dear visitor, the demo shop is temporarely down.', 'info@your+domain.com', '012-3456789', '012-3456788', '12345678', 'YourName', 'BankCity', 'BankCountry', 'TestBank', 'BankIBAN', 'BankBIC/Swiftcode', 2008, 'logo.gif', 2, 'This is my new shop!', 'FreeWebshop.org | New shop', 'This is the Footer', 0, 1, 0, '1.234,56', 60, 0, 2, 'm-d-Y @ G:i', 1, 1, 'default', 1, 0, 1, 0, 0, 'EUR', 1, 'these, are, keywords', 'ISO-8859-1', 1, 0, 1, 1, 1, 1, 130, 130, 50, 50, 450, 350, 1, 1, 1, 'Webshop powered by FreeWebshop.org', 15, 1, 1);
...
INSERT INTO `payment` VALUES (2, 'Contant / Cash', '', 1);
