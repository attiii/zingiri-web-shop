	...
	if (key!=null) {
		new AjaxUpload('upload_button', {
			...
			onComplete: function(file, response) {
				...
				aTag.attr('innerHTML','<img style="position:absolute;right:0px;top:0px;" src="'+wsURL+'../templates/default/images/delete.gif" height="16px" width="16px" />');
...
function wsDeleteImage(id) {
	...
	jQuery('#wsproduct').append(inputTag);
