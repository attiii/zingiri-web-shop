	...
	while ($row = mysql_fetch_array($sql)) {
		...
		if ($use_prodgfx == 1) {
			...
			if ($resized == 0) {
				...
				if ($use_imagepopup == 0) {
					$screenshot = "<a id=\"highlight_ref\" href=\"".$thumb."\"><div style=\"text-align:center;height:".$product_max_height."px\"><img class=\"borderimg\" id=\"highlight_image\" src=\"".$thumb."\" ".$height." ".$width." alt=\"\"/></div>".$txt['details9']."</a>";
				}
				else {
					$screenshot = "<a id=\"highlight_ref\" style=\"text-align:center;\" href=\"".$thumb."\" rel=\"lightbox\" title=\"".$txt['details2'].": ".$row[1]."\"><div style=\"text-align:center;height:".$product_max_height."px\"><img id=\"highlight_image\" class=\"borderimg\" src=\"".$thumb."\" ".$height." ".$width." alt=\"\"/></div>".$txt['details9']."</a>"; 
				}
			}
...
<table width="85%" class="datatable">
	<tr>
		...
		<br />-->
		<div id="productimages" style="text-align: center;"><?php echo $screenshot; ?><br />
		<?php
		//other images
