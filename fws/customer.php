...
<table width="80%" class="datatable">
	...
	<tr>
		...
		<table width="100%" class="borderless">
			...
			<tr>
				<td><?php echo $txt['customer15'] ?> (*)</td>
				<?php
				if ($action == show && IsAdmin() == false) { echo "<td>" . $login . "<input type=hidden name=login value='" . $login . "'></td>"; }
				else {
					?>
				<td><input type="text" name="login" size="15" maxlength="15"
					value="<?php echo $login ?>"></td>
					<?php } ?>
			</tr>
			<tr>
				<td><?php echo $txt['customer16'] ?> (*)</td>
				<td><input type="password" name="pass1" size="10" maxlength="10"
					value=""> <?php echo $txt['customer33']; ?></td>
			</tr>
			<tr>
				<td><?php echo $txt['customer17'] ?> (*)</td>
				<td><input type="password" name="pass2" size="10" maxlength="10"
					value=""></td>
			</tr>
			<tr>
				<td><?php echo $txt['customer18'] ?> (*)</td>
				<td><input type="text" name="surname" size="30" maxlength="30"
					value="<?php echo $surname ?>"></td>
			</tr>
			<tr>
				<td><?php echo $txt['customer19'] ?></td>
				<td><input type="text" name="middle" size="10" maxlength="10"
					value="<?php echo $middle ?>"></td>
			</tr>
			<tr>
				<td><?php echo $txt['customer20'] ?> (*)</td>
				<td><input type="text" name="initials" size="10" maxlength="10"
					value="<?php echo $initials ?>"></td>
			</tr>
			<tr>
				<td><?php echo $txt['customer30'] ?></td>
				<td><input type="text" name="company" size="30" maxlength="70"
					value="<?php echo $company ?>"></td>
			</tr>
			<tr>
				<td><?php echo $txt['customer21'] ?> (*)</td>
				<td><input type="text" name="address" size="30" maxlength="75"
					value="<?php echo $address ?>"></td>
			</tr>
			<tr>
				<td><?php echo $txt['customer22'] ?> (*)</td>
				<td><input type="text" name="zip" size="15" maxlength="15"
					value="<?php echo $zip ?>"></td>
			</tr>
			<tr>
				<td><?php echo $txt['customer23'] ?> (*)</td>
				<td><input type="text" name="city" size="30" maxlength="50"
					value="<?php echo $city ?>"></td>
			</tr>
			<tr>
				<td><?php echo $txt['customer1'] ?> (*)</td>
				<td><input type="text" name="state" size="30" maxlength="150"
					value="<?php echo $state ?>"></td>
			</tr>
			<tr>
				<td><?php echo $txt['customer24'] ?> (*)</td>
			...
			<tr>
				...
				<input type="hidden" name="pagetoload" value="<?php echo $pagetoload;?>" />
				<input type="submit" value="<?php echo $txt['customer28'] ?>"
					name="sub"><br />
				(<?php echo $txt['customer27'] ?>)</div>
				</td>
			</tr>
			<input type="hidden" name="customerid"
				value="<?php echo $customerid ?>"></form>
			</td>
			</td>
		</table>
