...
<table width="100%" class="datatable">
	...
	<tr>
		<td>
		<form method="post"
			action="<?php zurl('index.php?page=shipping',true);?>"><input
			type="hidden" name="step" value="2"> <?php echo $txt['shipping2'] ?><br />
		...
		<table width="100%" class="datatable">
			...
			<tr>
				<td>
				<form method="post"
					action="<?php zurl('index.php?page=discount',true);?>"><input
					type="hidden" name="shippingid" value="<?php echo $shippingid; ?>">
				<input type="hidden" name="weightid"
					value="<?php echo $weightid; ?>"> <?php echo $txt['shipping10'] ?><br />
