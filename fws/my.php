     ...
     <table width="80%" class="datatable">
      ...
      <tr><td>
           <table width="100%" class="borderless"><tr>
             ...
             <td><div style="text-align:center;"><a class="plain" href="index.php?zfaces=list&form=address&map=<?php echo faces_map(array('customerid' => $customerid));?>"><img src="<?php echo $gfx_dir; ?>/address.png" height="32px" alt="" /><br /><?php echo $txt['customer21'] ?></a></div></td>
