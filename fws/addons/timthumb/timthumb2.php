...
define ('FILE_CACHE_DIRECTORY', isset($_REQUEST["dir"]) ? $_REQUEST["dir"] : './cache');		// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
