...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_LOGIN_PASSWORD', '6767679');
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../up/'); 
	define('CONFIG_SYS_ROOT_PATH', '../../../up/');	//the root folder where the files would be uploaded to
