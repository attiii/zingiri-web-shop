...
(function (jQuery) {
    ...
    jQuery.extend(jQuery.ui, { timepicker: { version: "0.3.0"} });
    ...
    jQuery.extend(Timepicker.prototype, {
        ...
        _attachments: function (input, inst) {
            ...
            if (showOn == 'button' || showOn == 'both') { // pop-up time picker when 'button' element is clicked
                ...
                jQuery(button).bind("click.timepicker", function () {
                    if (jQuery.timepicker._timepickerShowing && jQuery.timepicker._lastInput == input[0]) {
                        jQuery.timepicker._hideTimepicker();
                    } else if (!inst.input.is(':disabled')) {
                        jQuery.timepicker._showTimepicker(input[0]);
                    }
                    return false;
                });
        ...
        _adjustZIndex: function(input) {
            ...
            inst.tpDiv.css('zIndex', jQuery.timepicker._getZIndex(input) +1);
        },
        ...
        _showTimepicker: function (input) {
            ...
            if ( ! inst.inline ) {
                ...
                jQuery.timepicker._adjustZIndex(input);
                //inst.tpDiv.css('zIndex', jQuery.timepicker._getZIndex(input) +1);
        ...
        _getZIndex: function (target) {
            var elem = jQuery( target ), position, value;
        ...
        _rebindDialogEvents: function (inst) {
            ...
            .find('.ui-timepicker-now').bind("click", function(e) {
                    jQuery.timepicker.selectNow(e);
            }).end()
            .find('.ui-timepicker-deselect').bind("click",function(e) {
                    jQuery.timepicker.deselectTime(e);
            }).end()
...
*/
        ...
        _enableTimepicker: function(target) {
            ...
            if (nodeName == 'input') {
                ...
                var button = this._get(inst, 'button');
                jQuery(button).removeClass('ui-state-disabled').disabled = false;
        ...
        _disableTimepicker: function(target) {
            ...
            if (nodeName == 'input') {
                ...
                jQuery(button).addClass('ui-state-disabled').disabled = true;
        ...
        _optionTimepicker: function(target, name, value) {
            ...
            if (arguments.length == 2 && typeof name == 'string') {
                return (name == 'defaults' ? jQuery.extend({}, jQuery.timepicker._defaults) :
        ...
        */
        ...
        selectNow: function(event) {
            var id = jQuery(event.target).attr("data-timepicker-instance-id"),
        ...
        deselectTime: function(event) {
            var id = jQuery(e.target).attr("data-timepicker-instance-id"),
                jQuerytarget = jQuery(id),
                inst = this._getInst(jQuerytarget[0]);
            inst.hours = -1;
            inst.minutes = -1;
        ...
        selectHours: function (event) {
            var jQuerytd = jQuery(event.currentTarget),
                ...
                newHours = parseInt(jQuerytd.attr("data-hour")),
        ...
        selectMinutes: function (event) {
            var jQuerytd = jQuery(event.currentTarget),
                id = jQuerytd.attr("data-timepicker-instance-id"),
                newMinutes = parseInt(jQuerytd.attr("data-minute")),
                fromDoubleClick = event.data.fromDoubleClick,
                jQuerytarget = jQuery(id),
                inst = this._getInst(jQuerytarget[0]),
                showHours = (this._get(inst, 'showHours') == true);
    ...
    jQuery.timepicker.version = "0.3.0";
