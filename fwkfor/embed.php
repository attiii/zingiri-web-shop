...
?>
<?php
define("ZING_APPS_PLAYER_VERSION","1.0.0");
...
function zScripts() {
	$v=array();
	$v[]='js/'.APHPS_JSDIR.'/sortlist.jquery.js';
	$v[]='js/'.APHPS_JSDIR.'/repeatable.jquery.js';
	$v[]='js/'.APHPS_JSDIR.'/formfield.jquery.js';
	$v[]='js/'.APHPS_JSDIR.'/core.jquery.js';
